...
<div class="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50">
	<div class="container mx-auto px-4 py-6">
		<div class="mb-6">
			<a href="/" class="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-white/80 border border-amber-200 text-amber-700 transition-all hover:bg-white hover:text-amber-900 hover:shadow-md">
